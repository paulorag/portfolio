...
export const dictionary = {
    pt: {
        ...
        footer: {
            ...
            text: "Estou disponível para novas oportunidades como Desenvolvedor Full-Stack. Se busca um profissional focado em qualidade técnica, estabilidade e entrega de valor, entre em contato.",
    ...
    en: {
        ...
        footer: {
            title: "Let's build",
            subtitle: "together?",
            text: "I am available for new opportunities as a Full-Stack Developer. If you are looking for an engineer committed to code excellence, reliability, and business impact, get in touch.",
